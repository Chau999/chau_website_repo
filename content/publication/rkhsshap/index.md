...
summary: We propose RKHS-SHAP, a SHAP algorithm specifically designed for kernel methods to compute both observational and interventional Shapley values efficiently using kernel mean embeddings.
